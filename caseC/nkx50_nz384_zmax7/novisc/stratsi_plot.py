...
#plt.tight_layout()
plt.subplots_adjust(left=0.25, right=0.9, top=0.9, bottom=0.125)
...
#ax.set_xlim(np.amin(ks),np.amax(ks))
#ax.set_ylim(-0.03,0.03)
#pos = ax.transLimits.transform((150, -0.01))

lines1, labels1 = ax.get_legend_handles_labels()
legend=ax.legend(lines1, labels1, loc=(0.05,0.02), frameon=False, ncol=2, fontsize=fontsize/2)
