...
filenames_1f = ['stratsi_1fluid_modes_eta'+x+'.h5' for x in eta_vals]
...
filenames_2f = ['stratsi_modes_eta'+x+'.h5' for x in eta_vals]
...
etas = [r'$\hat{\eta}=$'+x for x in eta_vals]
