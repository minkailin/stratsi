...
alpha0   = 1e-7#1e-5#1e-6   #alpha viscosity value, assumed constant
epsilon0 = 3.0#3.0     #midplane d/g ratio
st0      = 1e-2#1e-2#0.1   #assume a constant stokes number throughout 
