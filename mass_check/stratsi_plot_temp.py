...
'''
plt.plot(z, gas_mass_lhs.real, linewidth=2,label='lhs, real')
plt.plot(z, gas_mass_rhs.real, linewidth=2,label='rhs, real',linestyle='dashed')

plt.plot(z, gas_mass_lhs.imag, linewidth=2,label='lhs, imag')
plt.plot(z, gas_mass_rhs.imag, linewidth=2,label='rhs, imag',linestyle='dashed')
'''
